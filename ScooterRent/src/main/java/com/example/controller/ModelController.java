...
public class ModelController {
    ...
    public ModelListDto getVehicles(
    ...
    public ModelDto createTarif(@Valid @RequestBody ModelDto vehicleModelDto) {
    ...
    public void deleteTarif(@PathVariable Long id) {
        vehicleModelService.deleteModelVehicle(id);
    }
}
