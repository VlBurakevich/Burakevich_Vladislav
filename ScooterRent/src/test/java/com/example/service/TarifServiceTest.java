...
class TarifServiceTest {
    ...
    void testGetTarifs() {
        ...
        TarifListDto result = tarifService.getTarifs(0, 10);

        assertNotNull(result);
        assertEquals(1, result.getTarifs().size());
        assertEquals(tarifDto, result.getTarifs().getFirst());
    ...
    void testCreateTarif_Success() {
        ...
        TarifDto result = tarifService.createTarif(tarifDto);

        assertNotNull(result);
        assertEquals(tarifDto, result);
        assertEquals(transportType, tarif.getTransportType());
    ...
    void testUpdateTarif_Success() {
        ...
        TarifDto result = tarifService.updateTarif(id, tarifDto);

        assertNotNull(result);
        assertEquals(tarifDto, result);
        verify(tarifMapper, times(1)).updateEntityFromDto(tarifDto, existingTarif);
    ...
    void testDeleteTarif_Success() {
        ...
        assertDoesNotThrow(() -> tarifService.deleteTarif(id));
